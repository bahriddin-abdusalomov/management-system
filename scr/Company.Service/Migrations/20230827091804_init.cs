    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmployessId = table.Column<Guid>(type: "uuid", nullable: false),
                    StaffsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeStaff", x => new { x.EmployessId, x.StaffsId });
                    table.ForeignKey(
                        name: "FK_EmployeeStaff_Employees_EmployessId",
